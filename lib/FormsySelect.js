...
exports.FormsySelect = undefined;
...
var FormsySelect = exports.FormsySelect = function (_FormsyComponent) {
  _inherits(FormsySelect, _FormsyComponent);
  ...
  function FormsySelect() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FormsySelect.__proto__ || Object.getPrototypeOf(FormsySelect)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      hasChanged: false
      ...
      if (_this.props.onChange) _this.props.onChange(event, value, index);
  ...
  _createClass(FormsySelect, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['getErrorMessage', 'getErrorMessages', 'getValue', 'hasValue', 'innerRef', 'isFormDisabled', 'isFormSubmitted', 'isPristine', 'isRequired', 'isValid', 'isValidValue', 'onChange', 'resetValue', 'requiredError', 'setValidations', 'setValue', 'showError', 'showRequired', 'validationError', 'validationErrors', 'validations', 'value']);
      ...
      var value = this.state.hasChanged ? getValue() : valueProp;
